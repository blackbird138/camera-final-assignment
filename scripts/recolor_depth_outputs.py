#!/usr/bin/env python3
"""Recolor saved depth .npy outputs into demo PNGs."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="OpenCV colormap for recolored depth PNGs. jet is the red/blue demo style.",
    )
    parser.add_argument(
        "--vis-larger-is",
...
def recolor_directory(
    ...
    *,
    ...
    cv2_colormap = getattr(cv2, COLORMAPS[colormap])
    ...
    for npy_path in sorted(output_dir.rglob("*.npy")):
        ...
        depth_vis = cv2.applyColorMap(depth_uint8, cv2_colormap)
